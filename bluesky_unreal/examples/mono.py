...
bragg = UnrealSignal(preset_name="mono_remote", name= 'dcm_bragg')
para = UnrealSignal(preset_name="mono_remote", name='dcm_para')
perp = UnrealSignal(preset_name="mono_remote", name='dcm_perp')
color = UnrealSignal(preset_name="mono_remote", name='dcm_color')
